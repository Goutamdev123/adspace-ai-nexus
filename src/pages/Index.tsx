    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      >
        ...
        <main className="flex-1 overflow-auto">
          ...
          <section className="bg-muted/10 py-20 px-4 sm:px-6 lg:px-12">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto mb-8">
                We provide hyper-targeted advertising powered by real-time data and AI analytics, enabling measurable impact and enhanced customer engagement.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  { title: "Real-Time Data", desc: "Get instant updates on campaign performance." },
                  { title: "Hyperlocal Targeting", desc: "Reach specific audiences with geospatial precision." },
                  { title: "AI-Powered Insights", desc: "Leverage machine learning for ad optimization." },
                ].map((item, idx) => (
                  <div key={idx} className="p-6 bg-background rounded-xl shadow-md border border-border">
